...
@ManagedBean
@ViewScoped
public class Sgc008 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Sgc008> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Sgc008> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Sgc008>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Sgc008> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO SGC008 VALUES (?,?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SGC008 WHERE CODUSER || COMP || AREA in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
    	    ...
    	    if(coduser==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SGC008('" + ((String) filterValue).toUpperCase() + "','" + veccodu[0] + "','" + veccomp[0] + "','" + vecarea[0] + "', '" + instancia + "') FROM DUAL";
