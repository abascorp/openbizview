...
@ManagedBean
@ViewScoped
public class Cst001 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Cst001> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Cst001> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Cst001>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Cst001> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Cst001> list = new ArrayList<Cst001>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO CST001 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from CST001 WHERE CODIGO in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_CST001('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
