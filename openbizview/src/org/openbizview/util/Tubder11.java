...
@ManagedBean
@ViewScoped
public class Tubder11 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Tubder11> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Tubder11> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Tubder11>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Tubder11> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Tubder11> list = new ArrayList<Tubder11>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO TUBDER11 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from TUBDER11 WHERE CODIGO in (" + param + ") and INSTANCIA = " + instancia + "";
            ...
            try {
                ...
                if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001_FK3) violated - child record found")){
                ...
                if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001_FK4) violated - child record found")){
                   	
                   	//System.out.println("se cumple la condicion y muestro el msg");
                   	msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("sgc001fk3"), "");
                   }
               
                if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001_FK5) violated - child record found")){
                  	
                  	//System.out.println("se cumple la condicion y muestro el msg");
                  	msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("sgc001fk3"), "");
                  }
                   
                   if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001A_FK3) violated - child record found")){
                      	
                      	//System.out.println("se cumple la condicion y muestro el msg");
                      	msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("sgc001afk4"), "");
                   }
                   
                   if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001B_FK3) violated - child record found")){
                      	
                      	//System.out.println("se cumple la condicion y muestro el msg");
                      	msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("sgc001bfk4"), "");
                   }
                      
                   if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001C_FK3) violated - child record found")){
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_TUBDER11('" + ((String) filterValue).toUpperCase() + "', '" + instancia + "') FROM TUBDER11";
