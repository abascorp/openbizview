...
@ManagedBean
@ViewScoped
public class Tubder09 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Tubder09> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Tubder09> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Tubder09>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Tubder09> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Tubder09> list = new ArrayList<Tubder09>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO TUBDER09 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from TUBDER09 WHERE CODIGO in (" + param + ") and INSTANCIA = " + instancia + "";
            ...
            try {
                ...
                if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001D_FK4) violated - child record found")){
                ...
                if (e.getMessage().trim().equals("ORA-02292: integrity constraint (OPENBIZVIEW.SGC001_FK6) violated - child record found")){
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_TUBDER09('" + ((String) filterValue).toUpperCase() + "', '" + instancia + "') FROM DUAL";
