...
@ManagedBean
@ViewScoped
public class Indt09 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indt09> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indt09> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indt09>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indt09> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indt09> list = new ArrayList<Indt09>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDT09 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDT09 WHERE CODVEN in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE INDT09";
         query += " SET DESVEN = ?, ";
         query += " USRACT = ?,";
         query += " FECACT = '" + getFecha() + "'";
         query += " WHERE CODVEN = ? AND INSTANCIA = " + instancia + "";
 ...
 **/ 	
	public void select(int first, int pageSize, String sortField, Object filterValue) throws SQLException, ClassNotFoundException, NamingException {
     ...
     String query = "SELECT * FROM"; 
		...
		query += "(SELECT A.CODVEN, A.DESVEN ";
	    query += " FROM INDT09 A";
	    query += " GROUP BY A.CODVEN, A.DESVEN";
	    query += ")query ) " ;
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDT09('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
