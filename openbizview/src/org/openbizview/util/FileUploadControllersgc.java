...
@ManagedBean
@ViewScoped
public class FileUploadControllersgc extends Bd {
	...
	public void handleReportUpload(FileUploadEvent event) throws NamingException  {
		//System.out.println(event.getFile().getFileName());
		archivo = event.getFile().getFileName();
		//System.out.println(archivo);
		Sgc012b clase = new Sgc012b();
		clase.insert();
		 exten = Sgc012b.extension;
		     //System.out.println("Thread is running");
			 File ruta = new File(BIRT_VIEWER_WORKING_FOLDER + File.separator + exten + event.getFile().getFileName());
				try {
