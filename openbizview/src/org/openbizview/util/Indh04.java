...
@ManagedBean
@ViewScoped
public class Indh04 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh04> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh04> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh04>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh04> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indh04> list = new ArrayList<Indh04>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh04 VALUES (?,?,?,trim(?),ROUND(?,2),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
        ...
        pstmt.setFloat(5, Float.parseFloat(totpes));
        pstmt.setFloat(6, Float.parseFloat(totusd));
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh04 WHERE CODCIA || CODUBI || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
	...
	//System.out.println("entre al metodo UPDATE");
     try { 	 
	   ...
	   String[] vecsem = semcal.split("\\ - ", -1);
        ...
        pstmt.setFloat(3, Float.parseFloat(usdkgr));
        pstmt.setString(4, login);
        pstmt.setString(5, veccia[0].toUpperCase());
        pstmt.setString(6, vecubi[0].toUpperCase());
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
            ...
            String[] vecsem = semcal.split("\\ - ", -1);
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDH04('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + vecubi[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
