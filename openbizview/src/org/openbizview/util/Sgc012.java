    ...
    try {
        ...
        try {
            ...
            limpiarValores();                
		        ...
		        if (e.getMessage().trim().equals("ORA-02291: integrity constraint (OPENBIZVIEW.SGC012_FK4) violated - parent key not found")){msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("SGC_FK18"), ""); }
		   else {msj = new FacesMessage(FacesMessage.SEVERITY_FATAL, getMessage("msnPrimaryk"), "");}
