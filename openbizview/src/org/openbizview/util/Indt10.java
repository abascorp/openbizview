...
@ManagedBean
@ViewScoped
public class Indt10 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indt10> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indt10> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indt10>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indt10> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indt10> list = new ArrayList<Indt10>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDT10 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDT10 WHERE CODINV in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE INDT10";
         query += " SET DESINV = ?, ";
         query += " USRACT = ?,";
         query += " FECACT = '" + getFecha() + "'";
         query += " WHERE CODINV = ? AND INSTANCIA = " + instancia + "";
 ...
 **/ 	
	public void select(int first, int pageSize, String sortField, Object filterValue) throws SQLException, ClassNotFoundException, NamingException {
     ...
     String query = "SELECT * FROM"; 
		...
		query += "(SELECT A.CODINV, A.DESINV ";
	    query += " FROM INDT10 A";
	    query += " GROUP BY A.CODINV, A.DESINV";
	    query += ")query ) " ;
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDT10('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
