...
@ManagedBean
@ViewScoped
public class Sgc001c extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Sgc001c> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Sgc001c> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Sgc001c>(){
		/**
		 * 
		 */
		...
		@Override
		public List<Sgc001c> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Sgc001c> list = new ArrayList<Sgc001c>();
...
public void insertm() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO SGC001C VALUES (?,?,?,?,to_date('" + sdfecha.format(feccas) + "','dd/mm/yyyy'),?,?,'" + getFecha() + "',?,'" + getFecha() + "',?,OPENBIZVIEW.SGC001C_SEQ.NEXTVAL)";
        ...
        pstmt.setString(4, vectvalts[0].toUpperCase());
...
public void deletem() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SGC001C WHERE COMP || AREA || CODIGO || REGIST in (" + param + ") and INSTANCIA = " + instancia + "";        	
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SGC001C('" + ((String) filterValue).toUpperCase() + "','" + veccomp[0] + "','" + vecarea[0] + "','" + veccodigo[0] + "', '" + instancia + "') FROM DUAL";
