...
@ManagedBean
@ViewScoped
public class Cst004 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Cst004> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Cst004> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Cst004>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Cst004> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Cst004> list = new ArrayList<Cst004>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO TUBDER03A VALUES (?,?,?,'" + sdfecha3.format(fecini) + "','" + sdfecha3.format(fecfin) + "',?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from TUBDER03A WHERE ANOCAL || MESCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_TUBDER03A('" + ((String) filterValue).toUpperCase() + "') FROM DUAL";
