/*
 ...
 @ManagedBean
 @ViewScoped
 public class Indt04 extends Bd implements Serializable {
 ...
 /**
 	...
 	private LazyDataModel<Indt04> lazyModel;  
 	
 	
 	/**
 	 * @return the lazyModel
 	 */
 	public LazyDataModel<Indt04> getLazyModel() {
 		return lazyModel;
 	}	
 ...
 public void init() {
 	...
 	lazyModel  = new LazyDataModel<Indt04>(){
 		/**
 		 * 
 		 */
         ...
         @Override
 		public List<Indt04> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
         	//Filtro
         	if (filters != null) {
 	...
 	private List<Indt04> list = new ArrayList<Indt04>();
 ...
 public void insert() throws  NamingException {   	
     ...
     try {
         ...
         String query = "INSERT INTO INDT04 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
 ...
 public void delete() throws NamingException  {  
 	...
 	if (chkbox==null){
         ...
         try {
         	...
         	String query = "DELETE from INDT04 WHERE CODUBI in (" + param + ") and INSTANCIA = " + instancia + "";
 ...
 public void update() throws  NamingException {
 	//System.out.println("entre al metodo UPDATE");
      try { 	 
         ...
         String query = "UPDATE INDT04";
          query += " SET DESUBI = ?, ";
          query += " USRACT = ?,";
          query += " FECACT = '" + getFecha() + "'";
          query += " WHERE CODUBI = ? AND INSTANCIA = " + instancia + "";
  ...
  **/ 	
 	public void select(int first, int pageSize, String sortField, Object filterValue) throws SQLException, ClassNotFoundException, NamingException {
      ...
      String query = "SELECT * FROM"; 
 		...
 		query += "(SELECT A.CODUBI, A.DESUBI ";
 	    query += " FROM INDT04 A";
 	    query += " GROUP BY A.CODUBI, A.DESUBI";
 	    query += ")query ) " ;
     ...
     **/	
     ...
     public void counter(Object filterValue) throws SQLException, NamingException {
         ...
         try {	
      		...
      		//Consulta paginada
      		String query = "SELECT COUNT_INDT04('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
