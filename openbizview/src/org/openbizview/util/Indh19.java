...
@ManagedBean
@ViewScoped
public class Indh19 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh19> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh19> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh19>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh19> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private String tonpre = "";
	private String totrea = "";
	private String usdpre = "";
	private String usdrea = "";
	private Object filterValue = "";
	private List<Indh19> list = new ArrayList<Indh19>();
	...
	private String ztonpre = "";
	private String ztotrea = "";
	private String zusdpre = "";
	private String zusdrea = "";
	...
	public String getTotrea() {
		return totrea;
	}

	public void setTotrea(String totrea) {
		this.totrea = totrea;
	}

	public String getUsdpre() {
		return usdpre;
	}

	public void setUsdpre(String usdpre) {
		this.usdpre = usdpre;
	}

	public String getUsdrea() {
		return usdrea;
	}

	public void setUsdrea(String usdrea) {
		this.usdrea = usdrea;
	}

	public String getZtotrea() {
		return ztotrea;
	}

	public void setZtotrea(String ztotrea) {
		this.ztotrea = ztotrea;
	}

	public String getZusdpre() {
		return zusdpre;
	}

	public void setZusdpre(String zusdpre) {
		this.zusdpre = zusdpre;
	}

	public String getZusdrea() {
		return zusdrea;
	}

	public void setZusdrea(String zusdrea) {
		this.zusdrea = zusdrea;
	}
	...
	public String gettonpre() {
		return tonpre;
	}

	public void settonpre(String tonpre) {
		this.tonpre = tonpre;
	}
	...
	public String getZtonpre() {
		return ztonpre;
	}

	public void setZtonpre(String ztonpre) {
		this.ztonpre = ztonpre;
	}
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh19 VALUES (?,?,?,trim(?),ROUND(?,2),ROUND(?,2),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
        ...
        pstmt.setFloat(5, Float.parseFloat(tonpre));
        pstmt.setFloat(6, Float.parseFloat(totrea));
        pstmt.setFloat(7, Float.parseFloat(usdpre));
        pstmt.setFloat(8, Float.parseFloat(usdrea));
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh19 WHERE CODCIA || CODUBI || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
	...
	//System.out.println("entre al metodo UPDATE");
     try { 	 
	   ...
	   String[] vecsem = semcal.split("\\ - ", -1);
        ...
        String query = "UPDATE Indh19";
         query += " SET tonpre = ROUND(?,2), ";
         query += " totrea = ROUND(?,2), ";
         query += " usdpre = ROUND(?,2), ";
         query += " usdrea = ROUND(?,2), ";
         query += " USRACT = ?,";
         query += " FECACT = '" + getFecha() + "'";
         query += " WHERE CODCIA = ? AND CODUBI = ? AND ANOCAL = ? AND SEMCAL = trim(?) AND INSTANCIA = " + instancia + "";

        pstmt = con.prepareStatement(query);
        pstmt.setFloat(1, Float.parseFloat(tonpre));
        pstmt.setFloat(2, Float.parseFloat(totrea));
        pstmt.setFloat(3, Float.parseFloat(usdpre));
        pstmt.setFloat(4, Float.parseFloat(usdrea));
        pstmt.setString(5, login);
        pstmt.setString(6, veccia[0].toUpperCase());
        pstmt.setString(7, vecubi[0].toUpperCase());
        pstmt.setString(8, anocal.toUpperCase());
        pstmt.setString(9, vecsem[0].toUpperCase());//semcal.toUpperCase());
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
	        ...
	        if(semcal==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDH19('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + vecubi[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
