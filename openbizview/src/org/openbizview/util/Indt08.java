...
@ManagedBean
@ViewScoped
public class Indt08 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indt08> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indt08> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indt08>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indt08> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indt08> list = new ArrayList<Indt08>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDT08 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDT08 WHERE CODSEC in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE INDT08";
         query += " SET DESSEC = ?, ";
         query += " USRACT = ?,";
         query += " FECACT = '" + getFecha() + "'";
         query += " WHERE CODSEC = ? AND INSTANCIA = " + instancia + "";
 ...
 **/ 	
	public void select(int first, int pageSize, String sortField, Object filterValue) throws SQLException, ClassNotFoundException, NamingException {
     ...
     String query = "SELECT * FROM"; 
		...
		query += "(SELECT A.CODSEC, A.DESSEC ";
	    query += " FROM INDT08 A";
	    query += " GROUP BY A.CODSEC, A.DESSEC";
	    query += ")query ) " ;
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDT08('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
