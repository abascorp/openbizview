...
@ManagedBean
@ViewScoped
public class Indt07 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indt07> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indt07> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indt07>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indt07> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indt07> list = new ArrayList<Indt07>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDT07 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDT07 WHERE CODLIN in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE INDT07";
         query += " SET DESLIN = ?, ";
         query += " USRACT = ?,";
         query += " FECACT = '" + getFecha() + "'";
         query += " WHERE CODLIN = ? AND INSTANCIA = " + instancia + "";
 ...
 **/ 	
	public void select(int first, int pageSize, String sortField, Object filterValue) throws SQLException, ClassNotFoundException, NamingException {
     ...
     String query = "SELECT * FROM"; 
		...
		query += "(SELECT A.CODLIN, A.DESLIN ";
	    query += " FROM INDT07 A";
	    query += " GROUP BY A.CODLIN, A.DESLIN";
	    query += ")query ) " ;
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDT07('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
