...
@ManagedBean
@ViewScoped
public class Indh14 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh14> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh14> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh14>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh14> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indh14> list = new ArrayList<Indh14>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh14 VALUES (?,?,trim(?),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh14 WHERE CODCIA || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
	        ...
	        if(semcal==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_Indh14('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
