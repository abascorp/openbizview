...
public class FileUploadControllerThreadsgc extends Thread {
	// Constructor
	public FileUploadControllerThreadsgc(FileUploadEvent event) {
      this.event = event;
	}
	...
	public void run()  {		
		 ...
		 File ruta = new File(extContext.getRealPath(RUTA_REPORTE)+ File.separator + exten + event.getFile().getFileName());
