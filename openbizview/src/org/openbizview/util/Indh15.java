...
@ManagedBean
@ViewScoped
public class Indh15 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh15> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh15> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh15>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh15> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indh15> list = new ArrayList<Indh15>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh15 VALUES (?,?,trim(?),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh15 WHERE CODCIA || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
	        ...
	        if(semcal==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_Indh15('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
