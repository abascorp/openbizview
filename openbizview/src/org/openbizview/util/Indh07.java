...
@ManagedBean
@ViewScoped
public class Indh07 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh07> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh07> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh07>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh07> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indh07> list = new ArrayList<Indh07>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh07 VALUES (?,?,?,trim(?),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh07 WHERE CODCIA || CODUBI || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
	        ...
	        if(semcal==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDH07('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + vecubi[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
