...
@ManagedBean
@ViewScoped
public class Indh01 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh01> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh01> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh01>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh01> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indh01> list = new ArrayList<Indh01>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDH01 VALUES (?,?,?,TRIM(?),ROUND(?,2),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
        ...
        pstmt.setFloat(5, Float.parseFloat(totton));
        pstmt.setFloat(6, Float.parseFloat(totscp));
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDH01 WHERE CODCIA || CODUBI || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        pstmt.setFloat(3, Float.parseFloat(totusd));
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
            ...
            if(codcia==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDH01('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + vecubi[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
