...
@ManagedBean
@ViewScoped
public class Cst002 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Cst002> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Cst002> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Cst002>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Cst002> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Cst002> list = new ArrayList<Cst002>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO CST002 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from CST002 WHERE CODIGO in (" + param + ") and INSTANCIA = " + instancia + "";
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_CST002('" + ((String) filterValue).toUpperCase() + "','" + instancia + "') FROM DUAL";
