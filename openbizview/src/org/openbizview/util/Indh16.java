...
@ManagedBean
@ViewScoped
public class Indh16 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indh16> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indh16> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indh16>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indh16> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private String totpor = "";
	private Object filterValue = "";
	private List<Indh16> list = new ArrayList<Indh16>();
	...
	public String getTotpor() {
		return totpor;
	}

	public void setTotpor(String totpor) {
		this.totpor = totpor;
	}

	public String getZtotpor() {
		return ztotpor;
	}

	public void setZtotpor(String ztotpor) {
		this.ztotpor = ztotpor;
	}
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO Indh16 VALUES (?,?,trim(?),ROUND(?,2),ROUND(?,2),?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from Indh16 WHERE CODCIA || ANOCAL || SEMCAL in (" + param + ") and INSTANCIA = " + instancia + "";
	...
	//System.out.println("entre al metodo UPDATE");
     try { 	 
	   ...
	   String[] vecsem = semcal.split("\\ - ", -1);
        ...
        String query = "UPDATE Indh16";
         query += " SET totusd = ROUND(?,2), ";
         query += " totpor = ROUND(?,2), ";
         query += " USRACT = ?,";
        ...
        pstmt.setFloat(2, Float.parseFloat(totpor));
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
	        ...
	        if(semcal==null){
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_Indh16('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + anocal + "','" + vecsem[0] + "','" + instancia + "') FROM DUAL";
