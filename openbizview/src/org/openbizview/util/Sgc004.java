...
import org.primefaces.model.SortOrder;
	...
	@ManagedBean
	@ViewScoped
	public class Sgc004 extends Bd implements Serializable {
	...
	/**
		...
		private LazyDataModel<Sgc004> lazyModel;  
		
		
		/**
		 * @return the lazyModel
		 */
		public LazyDataModel<Sgc004> getLazyModel() {
			return lazyModel;
		}	
	...
	public void init() {
		...
		lazyModel  = new LazyDataModel<Sgc004>(){
			/**
			 * 
			 */
            ...
            @Override
			public List<Sgc004> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
            	//Filtro
            	if (filters != null) {
	...
	private List<Sgc004> list = new ArrayList<Sgc004>();
	 ...
	 */
	public void setList(List<Sgc004> list) {
		this.list = list;
	}
     ...
     **/ 	
     ...
     try {	
    	Context initContext = new InitialContext();     
 		...
 		//Consulta paginada
 		String query = "SELECT COUNT_SGC004('" + ((String) filterValue).toUpperCase() + "','" + login.toUpperCase() + "') FROM DUAL";
