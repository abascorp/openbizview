...
@ManagedBean
@ViewScoped
public class Sgc012a extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Sgc012a> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Sgc012a> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Sgc012a>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Sgc012a> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
    ...
    private Date fecacc = new Date();
	private Object filterValue = "";
	private List<Sgc012a> list = new ArrayList<Sgc012a>();
	...
	public Date getFecacc() {
		return fecacc;
	}

	public void setFecacc(Date fecacc) {
		this.fecacc = fecacc;
	}
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        pstmt.setString(7, respon.toUpperCase());
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from SGC012A WHERE REGIST in (" + param + ") and INSTANCIA = " + instancia + "";
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     try { 	 
        ...
        String query = "UPDATE SGC012a";
         query += " SET ACCION = ?, ";
         query += " RESPON = ?, ";
         query += " FECACC = to_date('" + sdfecha.format(fecacc) + "','dd/mm/yyyy'),";
         query += " USRACT = ?,";
        ...
        pstmt = con.prepareStatement(query);
        pstmt.setString(1, accion.toUpperCase());
        pstmt.setString(2, respon.toUpperCase());
        ...
        pstmt.setInt(9,Integer.parseInt(regist));
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        try {	
            ...
            String[] veccod = codigo.split("\\ - ", -1);
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_SGC012A('" + ((String) filterValue).toUpperCase() + "','" + veccomp[0] + "','" + vecarea[0] + "','" + veccod[0] + "','" + anocal + "','" + mescal + "', '" + instancia + "') FROM DUAL";
