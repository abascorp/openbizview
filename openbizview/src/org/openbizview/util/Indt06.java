...
@ManagedBean
@ViewScoped
public class Indt06 extends Bd implements Serializable {
...
/**
	...
	private LazyDataModel<Indt06> lazyModel;  
	
	
	/**
	 * @return the lazyModel
	 */
	public LazyDataModel<Indt06> getLazyModel() {
		return lazyModel;
	}	
...
public void init() {
	...
	lazyModel  = new LazyDataModel<Indt06>(){
		/**
		 * 
		 */
        ...
        @Override
		public List<Indt06> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) { 
        	//Filtro
        	if (filters != null) {
	...
	private List<Indt06> list = new ArrayList<Indt06>();
...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO INDT06 VALUES (?,?,?,'" + getFecha() + "',?,'" + getFecha() + "',?)";
...
public void delete() throws NamingException  {  
	...
	if (chkbox==null){
        ...
        try {
        	...
        	String query = "DELETE from INDT06 WHERE CODCIA || CODUBI in (" + param + ") and INSTANCIA = " + instancia + "";
	...
	//System.out.println("entre al metodo UPDATE");
     try { 	 
      ...
      String[] vecubi = codubi.split("\\ - ", -1);
        ...
        pstmt = con.prepareStatement(query);
        pstmt.setString(1, vecubi[0].toUpperCase());
    ...
    **/	
    ...
    public void counter(Object filterValue) throws SQLException, NamingException {
        ...
        String[] vecubi = codubi.split("\\ - ", -1);
     		...
     		//Consulta paginada
     		String query = "SELECT COUNT_INDT06('" + ((String) filterValue).toUpperCase() + "','" + veccia[0] + "','" + vecubi[0] + "','" + instancia + "') FROM DUAL";
