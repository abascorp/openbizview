	...
	function imprimir(codcia, codarea, codind, usuario, instancia){
	  // Si el mensaje que retorna es acceso
	    window.open('../ct/reportes.jsp?reporte=FAG017.rptdesign '
	    		+ "&codcia=" + codcia 
	    		+ "&area=" + codarea  
	    		+ "&indicador=" + codind
				+ "&usuario=" + usuario 
	...
	function log(){	
		...
		document.getElementById("formsgc013:codarea").value= "1";
		document.getElementById("formsgc013:codind").value= "1";
	
	    setTimeout("document.getElementById('formsgc013:codcia').value=''",300);
	   	setTimeout("document.getElementById('formsgc013:codarea').value=''",300);  
